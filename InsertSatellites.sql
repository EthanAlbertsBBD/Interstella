...
-- TODO: populate @SuperEntityID and check that @EntityTypeID fields are correct
...
The Moon has a very thin atmosphere, and its surface is covered in a layer of fine, powdery dust called regolith. It also has a very weak magnetic field and no liquid water on its surface, although scientists have found evidence of water molecules in the form of ice in some permanently shadowed craters near the poles.', @Size = 2.322e-5, @EntityTypeID = 5, @Mass = 1.23e-2, @DistanceFromEarth = '2.569 e-3 AU', @Temperature = 250 
...
Titan is larger than the planet Mercury, and it is the only moon in the Solar System known to have a substantial atmosphere. Its atmosphere is so dense that it distorts radar signals, making it difficult to study its surface.', @Size = 3.443e-5, @EntityTypeID = 5, @Mass = 2.25e-2, @DistanceFromEarth = '8.537 AU', @Temperature = 93.7 
...
Titania is also thought to have a subsurface ocean of liquid water, which could potentially harbor life. However, this has not been confirmed and remains a topic of scientific investigation.', @Size = 1.053e-5, @EntityTypeID = 5, @Mass = 5.693e-4, @DistanceFromEarth = '18.189 AU', @Temperature = 70 
